...
public class ProcessExecutor {
    ...
    public ProcessExecutor(File workingDirectory, List<String> command, Platform platform,
        ...
        this(workingDirectory, new ArrayList<String>(), command, platform, additionalEnvironment, 0);
    }
    ...
    public ShellExecutionOutput executeAndGetResult(final Logger logger) {
        ...
        if (exitValue == 0) {
            return new ShellExecutionOutput(stdout.toString().trim(), stderr.toString().trim());
        } else {
